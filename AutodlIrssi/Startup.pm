...
sub printVersionInfo {
	...
	message 3, "\x02\x0309Bugs and Requests:\x03\x02 \x02https://github.com/autodl-community\x02";
	message 3, "\x02\x0309Discussion:\x03\x02 \x02#autodl-community on irc.p2p-network.net\x02";
}
